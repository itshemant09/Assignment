...
<head runat="server">
    ...
    <title>West Pharmaceutical Login &amp; Register</title>
 ...
 <script type="text/javascript">
     ...
     {
         if (Email == "") {
             alert("Mobile number is missing. Please Enter Mobile Number.");
             return false;
         }
               ...
               <div class="container">
                   ...
                   <div class="row">
                         <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h1><strong>West Pharmaceutical</strong> Login &amp; Registration Form</h1>
                            
                            <div class="description">
                            	<p>
	                            	This is a free <strong>"Login and Registration form"</strong> for Patient's. 
                            	</p>                            
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
	                            		...
	                            		<p>Enter Mobile and OTP to log in:</p>

                                        <p>
                                            Test Login
                                        </p>
                                        <p>
                                            Patient: Mobile: 8123899837 OTP: 123
                                            Doctor:  Mobile: 7799578900 OTP: 123
                                        </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="loginEmail" runat="server" type="text" class="form-username form-control" placeholder="Mobile Number" ></asp:TextBox>
           
                                </div>

				                <div class="form-group">
				                        	
                                    <asp:TextBox ID="loginPassword" runat="server" type="password" class="form-username form-control" placeholder="OTP"></asp:TextBox>
